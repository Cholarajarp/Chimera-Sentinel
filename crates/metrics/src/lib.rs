...
pub static ACTIVE_WORKFLOWS: Lazy<GaugeVec> = Lazy::new(|| {
    register_gauge_vec!(
...
pub static WORKFLOW_STATE_TRANSITIONS: Lazy<CounterVec> = Lazy::new(|| {
    register_counter_vec!(
...
pub static POLICY_DECISIONS: Lazy<CounterVec> = Lazy::new(|| {
    register_counter_vec!(
...
pub static ATTESTATION_OPERATIONS: Lazy<CounterVec> = Lazy::new(|| {
    register_counter_vec!(
...
pub fn metrics_layer() -> tower::LayerFn<fn(axum::Router) -> axum::Router> {
    tower::LayerFn::new(|router: axum::Router| {
