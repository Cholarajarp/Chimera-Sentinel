...
use sentinel_domain::{
    ...
    ids::{AgentId, CaseId, CaseRunId, PolicyPackId, PolicyRuleRef, PrincipalId, TenantId, WorkflowId},
...
pub fn test_policy_pack() -> PolicyPack {
    PolicyPack {
        ...
        description: "Release admission controls for autonomous invoice processing agents".to_string(),
        ...
        rules: vec![
            ...
            PolicyRule {
                ...
                description: "Autonomous payment release prohibited without constrained reviewer reduction".to_string(),
...
pub fn test_candidate_revision(tenant_id: TenantId, capabilities: Vec<String>) -> CandidateRevision {
    let now = OffsetDateTime::now_utc();
    let abom = AgentBillOfMaterials {
        source_digest: RevisionDigest::sha256(b"source-code-v1"),
        registry_resource: "projects/sentinel-prod/locations/us-central1/agents/ap-agent-prod".to_string(),
        runtime_resource: "projects/sentinel-prod/locations/us-central1/runtimes/ap-runtime".to_string(),
...
pub fn test_evidence_bundle(tenant_id: TenantId, candidate: CandidateRevision) -> (EvidenceBundle, LedgerInvariants) {
    let now = OffsetDateTime::now_utc();
    ...
    let model_armor_events = vec![ModelArmorEvidence {
        ...
        provider_reference: "projects/sentinel-prod/locations/us-central1/templates/armor-template-v1".to_string(),
        provenance: Provenance::Live,
        timestamp: now,
    }];
    ...
    let gateway_decisions = vec![GatewayDecisionEvidence {
        ...
        allowed: false,
        policy_reference: "projects/sentinel-prod/locations/us-central1/gatewayPolicies/ap-least-privilege-v1".to_string(),
        provider_reference: "projects/sentinel-prod/locations/us-central1/gateways/gw-001".to_string(),
        provenance: Provenance::Live,
        timestamp: now,
    }];
