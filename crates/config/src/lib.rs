...
/// Mock ERP MCP configuration
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MockErpConfig {
    pub server: ServerConfig,
...
impl Default for MockErpConfig {
    fn default() -> Self {
        Self {
            server: ServerConfig {
            ...
            observability: ObservabilityConfig {
                otel_service_name: "sentinel-mock-erp-mcp".to_string(),
                ..Default::default()
            },
