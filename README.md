...
<p align="center">
  ...
  <em>Google All Things Agentic Hackathon 2026 — Fortified Enterprise Fleet Track</em>
</p>
...
<p align="center">
  ...
  <a href="docs/ARCHITECTURE.md"><img src="https://img.shields.io/badge/Google%20Cloud-Fortified%20Fleet-4285F4?style=for-the-badge&logo=google-cloud&logoColor=white" alt="Google Cloud" /></a>
...
<p align="center">
  ...
  <a href="docs/EVALUATION_AND_DEMO.md">Demo Guide</a>
</p>
...
flowchart TB
    ...
    subgraph BusinessFixture["Business Fixture"]
        ERP[Mock ERP MCP Server<br/><small>Deterministic Ledger Oracle</small>]
    end
...
> **Methodology**: 64 development cases for tuning + 16 sealed holdout cases run once after code freeze. See [`docs/EVALUATION_AND_DEMO.md`](docs/EVALUATION_AND_DEMO.md) for full methodology, baselines, ablations, and metrics.
...
│   ├── mock-erp-mcp/       # Rust MCP server (deterministic ledger oracle)
...
make run-mcp        # Mock ERP MCP Server    → :9090
...
| [`docs/EVALUATION_AND_DEMO.md`](docs/EVALUATION_AND_DEMO.md) | 80-case evaluation methodology, metrics, and demo script |
...
## 📜 Prior-Work Clean-Room Disclosure

Chimera Sentinel is a **clean-room implementation** created for the Google All Things Agentic Hackathon. **Chimera Vanguard** was prior research created for OpenAI Build Week. Sentinel reuses architectural lessons and security concepts (see [`docs/VANGUARD_TO_SENTINEL.md`](docs/VANGUARD_TO_SENTINEL.md)), but contains **zero copied Vanguard source code**, proprietary prompts, assets, or infrastructure.
...
<p align="center">
  <strong>Built with 🦁 for the Google All Things Agentic Hackathon 2026</strong><br/>
  <em>Fortified Enterprise Fleet Track</em>
</p>
